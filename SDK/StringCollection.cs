...
public class StringCollection : global::System.IDisposable 
    , global::System.Collections.Generic.IDictionary<string, string>
 {
  ...
  internal StringCollection(global::System.IntPtr cPtr, bool cMemoryOwn) {
    swigCMemOwn = cMemoryOwn;
    swigCPtr = new global::Microsoft.Win32.SafeHandles.SafeWaitHandle(cPtr, false);
  }

  internal static global::System.Runtime.InteropServices.SafeHandle getCPtr(StringCollection obj) {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr != null && swigCPtr.DangerousGetHandle() != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          csSmartIdEnginePINVOKE.delete_StringCollection(swigCPtr.DangerousGetHandle());
        }
  ...
  public StringCollectionEnumerator GetEnumerator() {
    return new StringCollectionEnumerator(this);
  }
  ...
  public StringCollection() : this(csSmartIdEnginePINVOKE.new_StringCollection__SWIG_0(), true) {
  }

  public StringCollection(StringCollection other) : this(csSmartIdEnginePINVOKE.new_StringCollection__SWIG_1(StringCollection.getCPtr(other).DangerousGetHandle()), true) {
    if (csSmartIdEnginePINVOKE.SWIGPendingException.Pending) throw csSmartIdEnginePINVOKE.SWIGPendingException.Retrieve();
  }

  private uint size() {
    uint ret = csSmartIdEnginePINVOKE.StringCollection_size(swigCPtr.DangerousGetHandle());
    return ret;
  }

  public bool empty() {
    bool ret = csSmartIdEnginePINVOKE.StringCollection_empty(swigCPtr.DangerousGetHandle());
    return ret;
  }

  public void Clear() {
    csSmartIdEnginePINVOKE.StringCollection_Clear(swigCPtr.DangerousGetHandle());
  }

  private string getitem(string key) {
    string ret = csSmartIdEnginePINVOKE.StringCollection_getitem(swigCPtr.DangerousGetHandle(), key);
    if (csSmartIdEnginePINVOKE.SWIGPendingException.Pending) throw csSmartIdEnginePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private void setitem(string key, string x) {
    csSmartIdEnginePINVOKE.StringCollection_setitem(swigCPtr.DangerousGetHandle(), key, x);
    if (csSmartIdEnginePINVOKE.SWIGPendingException.Pending) throw csSmartIdEnginePINVOKE.SWIGPendingException.Retrieve();
  }

  public bool ContainsKey(string key) {
    bool ret = csSmartIdEnginePINVOKE.StringCollection_ContainsKey(swigCPtr.DangerousGetHandle(), key);
    if (csSmartIdEnginePINVOKE.SWIGPendingException.Pending) throw csSmartIdEnginePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public void Add(string key, string val) {
    csSmartIdEnginePINVOKE.StringCollection_Add(swigCPtr.DangerousGetHandle(), key, val);
    if (csSmartIdEnginePINVOKE.SWIGPendingException.Pending) throw csSmartIdEnginePINVOKE.SWIGPendingException.Retrieve();
  }

  public bool Remove(string key) {
    bool ret = csSmartIdEnginePINVOKE.StringCollection_Remove(swigCPtr.DangerousGetHandle(), key);
    if (csSmartIdEnginePINVOKE.SWIGPendingException.Pending) throw csSmartIdEnginePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private global::System.IntPtr create_iterator_begin() {
    global::System.IntPtr ret = csSmartIdEnginePINVOKE.StringCollection_create_iterator_begin(swigCPtr.DangerousGetHandle());
    return ret;
  }

  private string get_next_key(global::System.IntPtr swigiterator) {
    string ret = csSmartIdEnginePINVOKE.StringCollection_get_next_key(swigCPtr.DangerousGetHandle(), swigiterator);
    return ret;
  }

  private void destroy_iterator(global::System.IntPtr swigiterator) {
    csSmartIdEnginePINVOKE.StringCollection_destroy_iterator(swigCPtr.DangerousGetHandle(), swigiterator);
  }
